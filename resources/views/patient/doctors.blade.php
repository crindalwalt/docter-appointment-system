                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="position-relative">
                            ...
                            <span class="badge bg-primary position-absolute top-0 end-0 m-3">Cardiology</span>
                        </div>
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <h4 class="fw-bold mb-1">Dr. Sarah Johnson</h4>
                                <p class="text-muted mb-2">Senior Cardiologist</p>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <p class="lead mb-lg-0">We're always looking for talented healthcare professionals to join our team.</p>
                    </div>
